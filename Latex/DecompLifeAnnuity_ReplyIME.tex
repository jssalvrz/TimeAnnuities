...
where \( v(y, t) \) denotes the discount factor based on forward interest rates generated with information available at time \( t \). Consequently, the quantity ${}_uV_x(t)$ represents the \textit{prospective reserve} of the annuity benefit. The reserve ${}_uV_x(t)$ is evaluated at time $u$ with information generated at time $t$. Taking the expectation of \ref{eq:Reserve1}, the prospective reserve reduces to:
